...
import io.sandbox.atlas_zones.config.data_types.StructurePoolConfig;
import io.sandbox.atlas_zones.config.data_types.ZoneConfig;
import io.sandbox.atlas_zones.processors.CleanupProcessor;
import io.sandbox.atlas_zones.processors.JigsawProcessor;
import io.sandbox.atlas_zones.processors.SpawnProcessor;
...
public class ZoneManager {
    ...
    public static Optional<Zone> generateZone(World world, PlayerEntity player, BlockPos blockPos, String zoneName) {
        ...
        zoneConfig.dimentionType = zoneConfig.dimentionType != null ? zoneConfig.dimentionType : "atlas_zones:blank_zone";
